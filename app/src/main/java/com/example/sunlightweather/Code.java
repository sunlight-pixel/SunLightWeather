...
public class Code {
    ...
    private static com.example.sunlightweather.Code bmpCode;

    public static com.example.sunlightweather.Code getInstance() {
        if(bmpCode == null)
            bmpCode = new com.example.sunlightweather.Code();
        return bmpCode;
    }
