    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_loginactivity_register:
                startActivity(new Intent(this, com.example.sunlightweather.RegisterActivity.class));
                finish();
                break;
            /**
             * 登录验证：
            ...
            case R.id.bt_loginactivity_login:
                ...
                if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(password)) {
                    ...
                    if (match) {
                        ...
                        Intent intent = new Intent(this, com.example.sunlightweather.MainActivity.class);
                        startActivity(intent);
                        finish();//销毁此Activity
                    } else {
