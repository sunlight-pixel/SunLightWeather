...
public class DBOpenHelper extends SQLiteOpenHelper {
     ...
     * @return
     */
    public ArrayList<com.example.sunlightweather.User> getAllData(){

        ArrayList<com.example.sunlightweather.User> list = new ArrayList<com.example.sunlightweather.User>();
        Cursor cursor = db.query("user",null,null,null,null,null,"name DESC");
        while(cursor.moveToNext()){
            String name = cursor.getString(cursor.getColumnIndex("name"));
            String password = cursor.getString(cursor.getColumnIndex("password"));
            list.add(new com.example.sunlightweather.User(name,password));
        }
        return list;
    }
}
